...
subprojects {
    ...
    configure<MavenPublishBaseExtension> {
        ...
        pom {
            ...
            url.set("https://github.com/aSoft-Ltd/kommerce")
            licenses {
                license {
                    name.set("MIT License")
                    url.set("https://github.com/aSoft-Ltd/kommerce/blob/master/LICENSE")
                }
            }
            developers {
                developer {
            ...
            scm {
                url.set("https://github.com/aSoft-Ltd/kommerce/")
                connection.set("scm:git:git://github.com/aSoft-Ltd/kommerce.git")
                developerConnection.set("scm:git:ssh://git@github.com/aSoft-Ltd/kommerce.git")
            }
        }
    }
}
